  ...
  return (
    <div className='flex flex-col gap-10'>
      <div className='w-3/5'>
        ...
        <SongElement title='AGENT 47' authors={["Oki"]} duration='2:30' id={1} cover={"/artists/oki/albums-covers/era47.jpg"} album='ERA 47'/>
        <SongElement title='Whoop?' authors={["Oki"]} duration='3:10' id={2} cover={"/artists/oki/albums-covers/47universe.jpg"} album='47UNIVERSE'/>
        ...
        <SongElement title='WODA SODOWA' authors={["Oki"]} duration='3:26' id={5} cover={"/artists/oki/albums-covers/era47.jpg"} album='ERA 47'/>
